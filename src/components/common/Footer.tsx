...
const Footer = (props: Props) => {
  return (
    <footer className="w-full">
      ...
      {/* main footer */}
      <SectionContainer sectionClass="bg-white px-2.5"
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to={'/'}>
              <img src={appStore} alt="app_store"
                className="w-fullx h-[60px]x object-containx"
              />
            </Link>
      ...
      <SectionFull
        ...
        containerClass="flex justify-between items-center py-6 px-2.5 md:px-0"
      >
        <div className="">
          &copy; 2026 Ecommerce.
        </div>
